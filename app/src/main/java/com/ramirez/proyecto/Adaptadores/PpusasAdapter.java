...
public class PpusasAdapter extends RecyclerView.Adapter<PpusasAdapter.PpusasViewHolder> {

    private List<PupusaEntity> bebidas;
    public Context context;


    @Override
    public PpusasViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_bebidas,parent,false);

        return (new PpusasViewHolder(v));
    }

    @Override
    public void onBindViewHolder(PpusasViewHolder holder, int position) {
        final PupusaEntity bebida = bebidas.get(position);
    ...
    public PpusasAdapter(List<PupusaEntity> bebidas, Context context) {
        this.bebidas = bebidas;
        this.context = context;
    }

    public static class PpusasViewHolder extends RecyclerView.ViewHolder {
        CardView cardview;
        ...
        public PpusasViewHolder(View itemView){
            super(itemView);
