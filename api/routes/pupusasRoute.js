...
const PupusasController = require('../controllers/pupusasController');


router.get('/', PupusasController.pupusas_get_all);

router.post('/', checkAuth, upload.single('productImage'), PupusasController.pupusas_insert_one);

router.delete('/:productId', checkAuth, PupusasController.pupusas_delete_one);

router.patch('/:productId', checkAuth, PupusasController.pupusas_patch_one);
