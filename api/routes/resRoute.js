...
const RecesController = require('../controllers/resController');


router.get('/', RecesController.reces_get_all);

router.post('/', checkAuth, upload.single('productImage'), RecesController.reces_insert_one);

router.delete('/:productId', checkAuth, RecesController.reces_delete_one);

router.patch('/:productId', checkAuth, RecesController.reces_patch_one);
